    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_created', models.BooleanField(default=False, help_text='True when the contact was created by an inbound channel (e.g. email-to-ticket) rather than a human; flagged for admin review.')),
                ...
                ('account', models.ForeignKey(blank=True, db_constraint=False, help_text='Primary account this contact belongs to', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='accounts.account')),
